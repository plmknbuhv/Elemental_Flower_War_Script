...
public class UtilityWindow : EditorWindow
{
    ...
    private readonly string _poolDirectory = "Assets/01_Work/HS/03_SO/ObjectPool";
    ...
    private void GeneratePoolingEnumFile()
    {
        ...
        string path = $"{Application.dataPath}/01_Work/HS/01_Script/Core/ObjectPool/PoolingType.cs";
        Debug.Log(path);
